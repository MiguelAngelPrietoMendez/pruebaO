...
! function(e) {
    ...
    var i = function(e) {
        ...
        p = {
           ...
           uploadIcon: '<i class="glyphicon glyphicon-upload text-info"></i>',
            ...
            indicatorNew: '<i style="display:none;" class="glyphicon glyphicon-hand-down text-warning"></i>',
        ...
        x = '<button type="button" class="kv-file-remove {removeClass}" title="{removeTitle}"{dataUrl}{dataKey}>{removeIcon}</button>\n',
          y = '<button style="display:none;" type="button" class="kv-file-upload {uploadClass}" title="{uploadTitle}">   {uploadIcon}\n</button>\n',
    ...
    H.prototype = {
        ...
        previewDefault: function(i, t, a) {
            if (this.showPreview) {
                var r = this,
                    ...
                    l = (e("#" + t), r.previewSettings.other || L.other),
        ...
        change: function(i) {
            ...
            if (R(n) || 0 === n.length) return m || a.clear(), a.showFolderError(v), void a.raise("fileselectnone");
        ...
        renderUpload: function() {
            var e = this,
                ...
                t = "",
                a = "";
            return e.showUpload ? (e.isDisabled && (a = " disabled "), t = !e.isUploadable || e.isDisabled ? '<button   type="submit" title="' + e.uploadTitle + '"class="' + i + '"' + a + ">" + e.uploadIcon + e.uploadLabel + "</button>" : '<a style="display:none;" href="' + e.uploadUrl + '" title="' + e.uploadTitle + '" class="' + i + '"' + a + ">" + e.uploadIcon + e.uploadLabel + "</a>") : ""
        }
