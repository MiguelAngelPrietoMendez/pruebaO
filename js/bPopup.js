...
(function (b) {
    b.fn.bPopup = function (z, F) {
        ...
        function A() {
            a.modal && b('<div class="b-modal ' + e + '"></div>').css({backgroundColor: a.modalColor, position: "fixed", top: 18, right: 0, bottom: 0, left: 0, opacity: 0, zIndex: a.zIndex + t}).appendTo(a.appendTo).fadeTo(a.speed, a.opacity);
            D();
                ...
                if (B = E())
                    clearTimeout(I), I = setTimeout(function () {
                        ...
                        c.dequeue().each(function () {
                            f ? b(this).css({left: v, top: 18}) : b(this).animate({left: a.follow[0] ? l(!0) : "auto", top: a.follow[1] ? n(!0) : "auto"}, a.followSpeed, a.followEasing)
                        })
                    }, 50)
            });
